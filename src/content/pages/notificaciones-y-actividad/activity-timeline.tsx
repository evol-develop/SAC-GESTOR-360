              ...
              >
                ...
                <div className="grid items-center gap-1">
                  <div className="sm:flex-row sm:items-center sm:justify-between flex flex-col">
                    ...
                    <span className="text-accent-foreground line-clamp-1 sm:ml-auto text-xs">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      {item.userId && item.userId !== "all" ? (
                        <UserAvatar
                          ...
                          className="border-secondary w-6 h-6 border"
                          withTooltip
                        />
                      ) : item.userId === "all" ? (
                          ...
                          <div className="flex items-center gap-1">
                            {item.groupIds.map((userId, index) => (
                              ...
                              <UserAvatar
                                ...
                                userId={userId}
                                rounded="rounded-full"
                                className="border-secondary first:m-0 w-6 h-6 -ml-3 border"
                                withTooltip
                                styles={{
                  ...
                  <p className="text-primary/75 line-clamp-1 text-xs">
                    <i>Tú: </i>
                    {item.details}
                  </p>
                </div>
